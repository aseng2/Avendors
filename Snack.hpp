...
class Snack
{
  ...
  public:
    ...
    Snack( std::string productName = {},                                // Default and Conversion (from string to GroceryItem) constructor
                 ...
                 std::string upcCode     = {},                                // good when combined with move semantics. 
                 double      price       = 0.0 );
   ...
   ~Snack           (                            )   noexcept;
    ...
    Snack & productName( std::string newProductName ) &;                // OK:     GroceryItem b; b.price(13.99);        (b is an l-value, i.e. a named object)
    ...
    std::weak_ordering operator<=>( Snack const & rhs ) const noexcept;
