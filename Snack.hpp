...
class Snack
{
  ...
  public:
    ...
    Snack( std::string productName = {},                                // Default and Conversion (from string to GroceryItem) constructor
                 ...
                 std::string upcCode     = {},
                 std::string vendingNum   = {},                                // good when combined with move semantics. 
                 double      price       = 0.0 );
   ...
   ~Snack           (                            )   noexcept;
    ...
    std::string const & vendingNum() const &;                                // that (listen carefully) haven't been overloaded.
    double              price      () const &;                                //
                                                                              //
    ...
    Snack & vendingNum    ( std::string newVendingNum     ) &;                // OK:     GroceryItem b; b.price(13.99);        (b is an l-value, i.e. a named object)
  ...
  private:
    ...
    std::string _vendingNum;                                                 // the name of the product (Ex: Heinz Tomato Ketchup - 2 Ct, Boston Market Spaghetti With Meatballs)
